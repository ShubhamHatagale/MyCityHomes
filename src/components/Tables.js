...
import { faUnlockAlt, faAngleDown, faAngleUp, faArrowDown, faArrowUp, faEdit, faEllipsisH, faExternalLinkAlt, faEye, faTrashAlt } from '@fortawesome/free-solid-svg-icons';
import { InputGroup, Form, Col, Row, Nav, Card, Image, Button, Table, Dropdown, ProgressBar, Pagination, ButtonGroup, Modal } from '@themesberg/react-bootstrap';
...
export const TransactionsTable = () => {
  ...
  const Register = () => {
      Axios.put("http://localhost:3002/adminReg/update", {
        id:id,
        name: name,
        username: username,
        email: email,
            ...
            <Card border="light" className="bg-white shadow-sm mb-4">
              <Card.Body>
                ...
                <Form>
                  ...
                  <div className="mt-3">
                    <Button variant="primary" onClick={Register} >Update</Button>
                  </div>
                </Form>
              </Card.Body>
            </Card>          </Modal.Body>
